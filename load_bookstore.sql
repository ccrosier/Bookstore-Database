...
/*
* Second index: find the phone number of a party the user wishes to contact, categorized by the ForeignID, E-mail and phone number. Reasoning: this index has been chosen in the case that the user wishes to make contact with the party (perhaps uses the phone number
* to make immediate contact, then use the e-mail address as a follow-up). Including the address didn't seem immedaitely pertinent, since most users would not be writing on paper directly to the party they wish to communicate with.
*/

CREATE INDEX contact_information
ON CONTACT (ForeignID, Email, Phone);
